...
export default function HMTPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-10 grid gap-12 rounded-lg border border-stone-200 bg-white p-6 shadow-sm md:p-10 lg:grid-cols-2 lg:items-center">
          <div className="flex min-h-[460px] items-center justify-center rounded-lg bg-stone-50 p-8">
            <Image src="/images/hmt-v2.png" alt="HMT Rice" width={500} height={600} className="h-[420px] w-auto object-contain" priority />
          </div>

          <div>
            <p className="text-sm font-bold uppercase tracking-[0.22em] text-emerald-700">Premium variety</p>
            <h1 className="mt-4 text-5xl font-extrabold leading-tight text-slate-950">HMT Rice</h1>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Our premium HMT Rice is carefully processed using advanced milling technology to preserve natural taste, aroma, softness, and nutritional value.
            </p>
